...
WebUI.callTestCase(findTestCase('FunctionalTestCase/Roles/JobRoleExists'), ["RoleName":"Data Analyst","ErrorMessage":"Role name already exists."],FailureHandling.STOP_ON_FAILURE)